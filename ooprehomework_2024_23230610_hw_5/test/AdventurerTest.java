...
public class AdventurerTest {
    ...
    public void testCarryItemWithMaxBottles() {
        ...
        adventurer.carryItem(4);
        assertEquals(3, adventurer.getBackpackSize()); // Should not add as it exceeds maxBottles
        assertFalse(adventurer.getBackpack().containsKey(4));
    }
    ...
    public void testCarryItemWithHighCombatEffectiveness() {
        ...
        assertEquals(21, adventurer.getBackpackSize());
        for (int i = 1; i <= 25; i++) {
            if (i <= 21) {
                assertTrue(adventurer.getBackpack().containsKey(i));
            } else {
